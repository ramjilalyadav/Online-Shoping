    ...
    <body>
        <div>
           ...
           <footer class="footer">
               <div class="container">
                <center>
                   <p>Copyright &copy <a href="#">Yadav</a> Store. All Rights Reserved.</p>
                   <p>This website is developed by Ramjilal Yadav</p>
               </center>
               </div>
           </footer>
        </div>
